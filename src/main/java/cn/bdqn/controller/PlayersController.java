...
public class PlayersController {
    ...
    public String playersList(HttpSession session, Model model, @RequestParam(value = "pname",required = false)String pname, @RequestParam(value = "cid",required = false)Integer cid, @RequestParam(value = "currPageNo",defaultValue = "1")Integer currPageNo){
        if (pname!=null){
        ...
        PageBean<Players> pageBean=playersService.playersList(pname,cid,2,currPageNo);
